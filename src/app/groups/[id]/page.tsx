...
import { Group, groups, LessonSelect } from "../../../../lib/db/schema";
...
export default function GroupShedulePage({ params }: {params: Promise<{id: string}>}) {
  ...
  const createLesson = async (lessonData: createLessonFormData) => {
    try {
  ...
  return (
    <div>
      {isOpenModalCreateLesson && (
        <div className="bg-black z-10 fixed inset-0 bg-opacity-50 w-screen h-screen flex items-center justify-center">
          <div className="bg-white w-2/5 rounded-lg fixed z-20">
            <div className="p-6">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-2xl font-bold text-gray-800">Добавьте новое занятие</h2>
                <X className="hover:cursor-pointer" onClick={closeModalCreateLesson}></X>
              </div>
              <div className="">
                {createLessonError !== "" && (
